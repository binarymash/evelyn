...
////            _projectionBuilder = Substitute.For<IProjectionBuilder<ProjectionBuilderRequest, EnvironmentDetailsDto>>();
////            _db = Substitute.For<IDatabase<string, EnvironmentDetailsDto>>();
...
////        {
////            _projection1 = _fixture.Create<EnvironmentDetailsDto>();
...
////        {
////            _projection1 = _fixture.Create<EnvironmentDetailsDto>();
////            _projection2 = _fixture.Create<EnvironmentDetailsDto>();
...
////            _eventStreamFactory.GetEventStream<EnvironmentDetailsDto>().Enqueue(_event1);
////        }

////        private void WhenEvent2IsAddedToTheEventStream()
////        {
////            _event2 = _fixture.Create<EnvironmentAdded>();
////            _eventStreamFactory.GetEventStream<EnvironmentDetailsDto>().Enqueue(_event2);
////        }
...
////        {
////            _db.DidNotReceiveWithAnyArgs().AddOrUpdate(Arg.Any<string>(), Arg.Any<EnvironmentDetailsDto>());
////        }
...
////        {
////            _eventStreamFactory.GetEventStream<EnvironmentDetailsDto>().Should().NotContain(@event);
////        }
////    }
////}
