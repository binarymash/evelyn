namespace Evelyn.Core.Tests.WriteModel.Project
{
    ...
    public class AddToggleValidatorSpecs
    {
        private readonly Fixture _fixture;
        private readonly AddToggleValidator _validator;

        public AddToggleValidatorSpecs()
        {
            _fixture = new Fixture();
            _validator = new AddToggleValidator();
        }

        [Fact]
        public void ProjectIdWhenNominalGuidIsValid()
        {
            var command = _fixture.Create<AddToggle>();
        ...
        public void ProjectIdWhenEmptyGuidIsInvalid()
        {
            ...
            var command = _fixture.Build<AddToggle>().With(c => c.ProjectId, projectId).Create();
        ...
        public void KeyWhenNominalIsValid()
        {
            ...
            var command = _fixture.Build<AddToggle>().With(c => c.Key, key).Create();
        ...
        public void ExpectedProjectVersionWhenNullIsValid()
        {
            ...
            var command = _fixture.Build<AddToggle>().With(c => c.ExpectedProjectVersion, expectedProjectVersion).Create();
        ...
        public void ExpectedProjectVersionWhenNegativeIsInvalid()
        {
            ...
            var command = _fixture.Build<AddToggle>().With(c => c.ExpectedProjectVersion, expectedVersion).Create();
        ...
        public void NameWhenNullIsInvalid()
        {
            ...
            var command = _fixture.Build<AddToggle>().With(c => c.Name, name).Create();
