...
////            var logger = Substitute.For<ILogger<SubscriptionPublisher>>();
...
////            _subscriptionPublisher = new SubscriptionPublisher(logger, new EventStoreConnectionFactory(), eventPublisher);
